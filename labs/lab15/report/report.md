...
Аналогичным образом скопируем утилиту lnav на клиентскую машину и запустим её (рис. [-@fig:012]).

![Установка и запуск lnav на клиенте](image/12.png){#fig:012}

Убедимся, что на клиенте интерфейс lnav также корректно отображает системные журналы (рис. [-@fig:013]).

![Просмотр логов через lnav на клиенте](image/13.png){#fig:013}
