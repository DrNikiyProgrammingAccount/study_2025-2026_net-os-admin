...
Теперь, как мы видим, появилось новое письмо с идентификатором EBE862044889. Как видим, в предпоследней строке сказано, что оно успешно доставлено (delivered to mailbox) (рис. [-@fig:018]).
...
Как видим, наше письмо 7482D204488 не доставилось, потому что нет информации о каком-либо почтовом сервере (No route to host) (рис. [-@fig:020]).
