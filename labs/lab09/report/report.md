...
Посмотрим, что появилось в логах на сервере. Как мы видим, сервер успешно обработал 2 письма с двумя разными идентификаторами - 896BE2044481 и EFFC82044481. Мы можем судить об успешной отправке по припискам delivered to maildir (рис. [-@fig:021]).
